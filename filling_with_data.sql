...
insert into packer_of_position_in_order (order_id, product_id, employee_id)
  values
  (104394, 038284, 593024),
  (104394, 749204, 593024),
  (125932, 472910, 937833),
  (103928, 938602, 549253),
  (183320, 837932, 549253),
  (184920, 820174, 593024),
  (113894, 837932, 463263),
  (113894, 472910, 463263),
  (113894, 137853, 463263),
  (068383, 028562, 104836),
  (492853, 038284, 948292),
  (674932, 859275, 549253),
